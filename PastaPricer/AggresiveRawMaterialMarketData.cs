...
// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="AggresiveRawMaterialMarketData.cs" company="No lock... no deadlock" product="Michonne">
...
namespace PastaPricer
{
    ...
    public class AggresiveRawMaterialMarketData : IRawMaterialMarketData
    {
        ...
        /// The aggression Factor.
        /// </param>
        public AggresiveRawMaterialMarketData(
            string rawMaterialName, 
            int timerPeriodInMsec = 9, 
            int aggressionFactor = 300)
        {
