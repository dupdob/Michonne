...
namespace PastaPricer.Tests
{
    ...
    public class PastaCalculatorTests
    {
        ...
        public void Should_compute_expected_price()
        {
            ...
            Check.That(pastaCalculator.Compute(flourPrice: 1.3m, eggsPrice: 2.4m, flavorPrice: 1.2m)).IsEqualTo(1.92m);
            Check.That(pastaCalculator.Compute(flourPrice: 1.9m, eggsPrice: 2.4m, flavorPrice: 1.2m)).IsEqualTo(2.52m);
        }
    }
    ...
    public class PastaCalculator
    {
        ...
        {
            return Math.Round(0.5m + flourPrice + 1 / 4 * eggsPrice + 0.1m * flavorPrice, 2);
        }
    }
}
